        ...
        try:
            match options:
                ...
                case "4":
                    ...
                    validador = val(pendentes_list, session, args.contrato, args.revalorar, token, args.session)
                case "5":
                    ...
                    validador = val(pendentes_array, session, args.contrato, args.revalorar, token, args.session)
                case "6":
                    tses_existentes = sql_view.Sql("", "")
                    console.print("\n", tses_existentes.show_tses(), style="italic blue", justify="full")
                ...
                case "8":
                    ...
                    validador = val(planilha, session, args.contrato, args.revalorar, token, args.session)
                case "9":
